...
//Using Namespace:Mengizinkan penggunaan elemen dari namespace std tanpa perlu menuliskan std:: setiap kali.
//Fungsi main:Titik awal eksekusi program.
//Mendeklarasikan dua variabel bertipe int, alas dan tinggi, dengan nilai masing-masing 1213 dan 1619.
//static_cast<double>(alas): Mengubah tipe alas menjadi double agar hasil pembagian lebih akurat (mencegah pembulatan integer)
